...
@available(iOS 26.0, *)
public struct CoolThemeProvider: View {
  private let props: CoolComponentProps
  private let onEvent: (CoolComponentEvent) -> Void

  public init(_ props: CoolComponentProps = .init(label: "ThemeProvider"), onEvent: @escaping (CoolComponentEvent) -> Void = { _ in }) {
    self.props = props
    self.onEvent = onEvent
  }

  public var body: some View {
    CoolGeneratedComponent(name: "ThemeProvider", interactive: false, props: props, onEvent: onEvent)
  }
}

@available(iOS 26.0, *)
public struct CoolBackdrop: View {
  private let props: CoolComponentProps
  private let onEvent: (CoolComponentEvent) -> Void

  public init(_ props: CoolComponentProps = .init(label: "Backdrop"), onEvent: @escaping (CoolComponentEvent) -> Void = { _ in }) {
    self.props = props
    self.onEvent = onEvent
  }

  public var body: some View {
    CoolGeneratedComponent(name: "Backdrop", interactive: false, props: props, onEvent: onEvent)
  }
}

@available(iOS 26.0, *)
public struct CoolGlassSurface: View {
  private let props: CoolComponentProps
  private let onEvent: (CoolComponentEvent) -> Void

  public init(_ props: CoolComponentProps = .init(label: "GlassSurface"), onEvent: @escaping (CoolComponentEvent) -> Void = { _ in }) {
    self.props = props
    self.onEvent = onEvent
  }

  public var body: some View {
    CoolGeneratedComponent(name: "GlassSurface", interactive: false, props: props, onEvent: onEvent)
  }
}

@available(iOS 26.0, *)
public struct CoolGlassGroup: View {
  private let props: CoolComponentProps
  private let onEvent: (CoolComponentEvent) -> Void

  public init(_ props: CoolComponentProps = .init(label: "GlassGroup"), onEvent: @escaping (CoolComponentEvent) -> Void = { _ in }) {
    self.props = props
    self.onEvent = onEvent
  }

  public var body: some View {
    CoolGeneratedComponent(name: "GlassGroup", interactive: false, props: props, onEvent: onEvent)
  }
}
...
public struct CoolDivider: View {
  ...
  public init(_ props: CoolComponentProps = .init(label: "Divider"), onEvent: @escaping (CoolComponentEvent) -> Void = { _ in }) {
    self.props = props
    self.onEvent = onEvent
  }

  public var body: some View {
    CoolGeneratedComponent(name: "Divider", interactive: false, props: props, onEvent: onEvent)
  }
}
