...
TopBar is a navigation component. Its contract aligns geometry and semantics while each implementation preserves platform-native behavior.
...
```swift
CoolTopBar(/* typed platform parameters */)
```
